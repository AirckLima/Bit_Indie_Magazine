            ...
            <div className="relative flex flex-col place-content-center">
                <nav id="desktop-navigation" className="basis-1/3 absolute right-2 flex flex-row justify-end">
                    ...
                    <ul id="desktop-nav-links" className="hidden">
                        <li><a href="" className={ ` ${path === "/" ? "text-slate-400 " : ""} ` }>Link 1</a></li>
                        <li><a href="" className={ ` ${path === "/" ? "text-slate-400 " : ""} ` }>Link 2</a></li>
                        <li><a href="" className={ ` ${path === "/" ? "text-slate-400 " : ""} ` }>Link 3</a></li>
                        <li><a href="" className={ ` ${path === "/" ? "text-slate-400 " : ""} ` }>Link 4</a></li>
                    </ul>
                </nav>
            </div>
                ...
                <div className="absolute top-0 left-0">
                    <div id="navigation-screen" className="fixed top-0 flex flex-col h-screen w-screen place-content-center z-10 bg-amber-400 opacity-95">
                        ...
                        <ul className="relative -top-10 text-center text-2xl font-kode font-bold space-y-12">
                            ...
                            <li><Link href={ "/editions" } className={ ` ${path === "/editions" ? "pointer-events-none text-slate-400 " : ""} ` } onClick={(e)=>{}}>Link 1</Link></li>
                            <li><a className={ ` pointer-events-none ${path === "/" ? "text-slate-400 " : ""} ` } href="">Link 2</a></li>
                            <li><a className={ ` pointer-events-none ${path === "/" ? "text-slate-400 " : ""} ` } href="">Link 3</a></li>
                            <li><a className={ ` pointer-events-none ${path === "/" ? "text-slate-400 " : ""} ` } href="">Link 4</a></li>
                        </ul>
                    </div>
                </div>
            </aside>
